"""
Django settings for EventExpert project.
...
SECRET_KEY = 'django-insecure-!w*a=5!3_m!dt((kx(@vblbznu)^dojyomnoa)*@u83sxc8%@'
...
INSTALLED_APPS = [
    ...
    'corsheaders',  # CORS for handling frontend-backend communication
    'rest_framework_simplejwt',  # JWT authentication

    #  apps
    'events',  # The events app you'll create for event management
    'users',
]
...
CORS_ALLOWED_ORIGINS = [
    'http://localhost:3000',  # React app on this port
]

ROOT_URLCONF = 'EventExpert.urls'
...
WSGI_APPLICATION = 'EventExpert.wsgi.application'
